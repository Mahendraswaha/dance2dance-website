...
10. **Agenda Integrada & Wishlist com Meta de 10 Pessoas nas Páginas dos Workshops:**
   * **Posicionamento & Hierarquia:** Seção posicionada logo abaixo da chamada *"Pronto para começar?"*, tornando o fluxo de leitura natural (o convite de ação é seguido imediatamente pelas turmas ou pela lista de interesse).
   * **Largura Padronizada com a Agenda:** Container expandido para `max-w-6xl mx-auto w-full px-4 sm:px-6 md:px-8`, garantindo que os cards tenham exatamente o mesmo tamanho e espaçamento visual da página `/agenda`.
   ...
   * **Botão "Ver agenda completa":** Atualizado de *"Ver datas disponíveis"* para *"Ver agenda completa"* (nos 3 idiomas), permitindo explorar todo o calendário de outros cursos após ver as datas daquele workshop.
