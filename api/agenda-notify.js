    ...
    if (type === 'enrolled') {
      if (lang === 'en') {
        ...
        htmlContent = `
          ...
          <p>We have confirmed your registration:</p><p style="margin-bottom: 5px;">workshop: <a href="${workshopLink}" style="color: #C9A84C; text-decoration: none;"><strong>${workshopName}</strong></a></p><p style="margin-top: 0; margin-bottom: 5px;">date: ${workshopDate}</p><p style="margin-top: 0;">time: ${workshopTime}</p>
        ...
        htmlContent = `
          ...
          <p>Vi har bekreftet din registrering:</p><p style="margin-bottom: 5px;">workshop: <a href="${workshopLink}" style="color: #C9A84C; text-decoration: none;"><strong>${workshopName}</strong></a></p><p style="margin-top: 0; margin-bottom: 5px;">dato: ${workshopDate}</p><p style="margin-top: 0;">tid: ${workshopTime}</p>
        ...
        htmlContent = `
          ...
          <p>Confirmamos sua inscri&ccedil;&atilde;o:</p><p style="margin-bottom: 5px;">workshop: <a href="${workshopLink}" style="color: #C9A84C; text-decoration: none;"><strong>${workshopName}</strong></a></p><p style="margin-top: 0; margin-bottom: 5px;">dia: ${workshopDate}</p><p style="margin-top: 0;">hora: ${workshopTime}</p>
        ...
        if (lang === 'en') {
          ...
          htmlContent = `
            <div class="greeting">Hello ${userName}.</div>
            <p>You have successfully joined the waitlist:</p><p style="margin-bottom: 5px;">workshop: <a href="${workshopLink}" style="color: #C9A84C; text-decoration: none;"><strong>${workshopName}</strong></a></p><p style="margin-top: 0; margin-bottom: 5px;">date: ${workshopDate}</p><p style="margin-top: 0;">time: ${workshopTime}</p>
          ...
          htmlContent = `
            <div class="greeting">Hei ${userName}.</div>
            <p>Du st&aring;r n&aring; p&aring; ventelisten:</p><p style="margin-bottom: 5px;">workshop: <a href="${workshopLink}" style="color: #C9A84C; text-decoration: none;"><strong>${workshopName}</strong></a></p><p style="margin-top: 0; margin-bottom: 5px;">dato: ${workshopDate}</p><p style="margin-top: 0;">tid: ${workshopTime}</p>
          ...
          htmlContent = `
            ...
            <p>Voc&ecirc; entrou na lista de espera:</p><p style="margin-bottom: 5px;">workshop: <a href="${workshopLink}" style="color: #C9A84C; text-decoration: none;"><strong>${workshopName}</strong></a></p><p style="margin-top: 0; margin-bottom: 5px;">dia: ${workshopDate}</p><p style="margin-top: 0;">hora: ${workshopTime}</p>
      ...
      if (lang === 'en') {
        ...
        htmlContent = `
          <div class="greeting">Hello ${userName}.</div>
          <p>The waitlist has moved and your spot has been confirmed:</p><p style="margin-bottom: 5px;">workshop: <a href="${workshopLink}" style="color: #C9A84C; text-decoration: none;"><strong>${workshopName}</strong></a></p><p style="margin-top: 0; margin-bottom: 5px;">date: ${workshopDate}</p><p style="margin-top: 0;">time: ${workshopTime}</p>
        ...
        htmlContent = `
          <div class="greeting">Hei ${userName}.</div>
          <p>Ventelisten har flyttet seg, og din plass er bekreftet:</p><p style="margin-bottom: 5px;">workshop: <a href="${workshopLink}" style="color: #C9A84C; text-decoration: none;"><strong>${workshopName}</strong></a></p><p style="margin-top: 0; margin-bottom: 5px;">dato: ${workshopDate}</p><p style="margin-top: 0;">tid: ${workshopTime}</p>
        ...
        htmlContent = `
          <div class="greeting">Olá, ${userName}.</div>
          <p>A lista de espera girou e sua vaga foi confirmada:</p><p style="margin-bottom: 5px;">workshop: <a href="${workshopLink}" style="color: #C9A84C; text-decoration: none;"><strong>${workshopName}</strong></a></p><p style="margin-top: 0; margin-bottom: 5px;">dia: ${workshopDate}</p><p style="margin-top: 0;">hora: ${workshopTime}</p>
