    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
        ...
        <motion.div
          ...
          className="relative w-full max-w-lg bg-[#121218] border border-[#2B2B38] rounded-[4px] p-6 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.8)] z-10 text-left overflow-hidden"
        >
