    ...
    <div className="pt-48 md:pt-56 pb-24 bg-primary min-h-screen font-sans text-background relative">
      ...
      <div className="max-w-[900px] mx-auto px-12 md:px-20 lg:px-24 relative z-10">
        ...
        <div className="mt-20 pt-16 border-t border-[#222222] flex flex-col items-center">
          ...
          <Link 
            to="/agenda" 
            className="inline-block text-center font-heading text-[12px] tracking-[3px] uppercase bg-accent text-primary px-8 py-4 hover:bg-background hover:text-primary transition-colors duration-300 font-semibold rounded-full mb-12"
          >
